...
export default function Hero() {
  useEffect(() => {
    // #region agent log
    fetch("http://127.0.0.1:7314/ingest/1e07544f-3a19-4697-806c-d0e694f56fa4", {
      method: "POST",
      headers: { "Content-Type": "application/json", "X-Debug-Session-Id": "753467" },
      body: JSON.stringify({
        sessionId: "753467",
        runId: "pre-fix",
        hypothesisId: "H1",
        location: "src/components/ui/demo.tsx:1",
        message: "Hero demo mounted",
